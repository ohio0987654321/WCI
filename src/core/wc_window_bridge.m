...
#import "../util/wc_process_manager.h"
...
+ (NSArray<NSNumber *> *)getChildProcessesForPID:(pid_t)pid {
    return [WCProcessManager getChildProcessesForPID:pid];
}
...
+ (NSArray<NSNumber *> *)getElectronRendererProcessesForMainPID:(pid_t)mainPID {
    return [WCProcessManager getElectronRendererProcessesForMainPID:mainPID];
}

+ (NSArray<NSNumber *> *)getChromeRendererProcessesForMainPID:(pid_t)mainPID {
    return [WCProcessManager getChromeRendererProcessesForMainPID:mainPID];
}

+ (NSString *)getProcessNameForPID:(pid_t)pid {
    return [WCProcessManager getProcessNameForPID:pid];
}
